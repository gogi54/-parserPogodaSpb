...
public class Parser {
    ...
    //Метод получает дату из строки
    Matcher matchger = pattern.matcher(stringDate);
        if (matchger.find()) {
            return matchger.group();
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // css query language (Позволяет делать запросы к странице и доставать нужные данные)
